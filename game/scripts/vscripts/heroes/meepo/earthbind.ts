...
class meepo_earthbind_lua extends CDOTA_Ability_Lua {
  ...
  OnProjectileHit(target,location) {
    ...
    let units = FindUnitsInRadius(caster.GetTeamNumber(),location,null,radius,DOTA_UNIT_TARGET_TEAM.DOTA_UNIT_TARGET_TEAM_ENEMY,DOTA_UNIT_TARGET_TYPE.DOTA_UNIT_TARGET_BASIC+DOTA_UNIT_TARGET_TYPE.DOTA_UNIT_TARGET_HERO,DOTA_UNIT_TARGET_FLAGS.DOTA_UNIT_TARGET_FLAG_NONE,0,false)
